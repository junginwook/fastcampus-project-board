...
public class UserAccountServiceTest {
	...
	void givenUserParams_whenSaving_thenSavesUserAccount() {
		//Given
		UserAccount userAccount = createUserAccount("inwook");
		UserAccount savedAccount = createSigningUpUserAccount("inwook");
		given(userAccountRepository.save(userAccount)).willReturn(savedAccount);
